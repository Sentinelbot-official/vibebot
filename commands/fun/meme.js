        ...
        .addFields(
          {
            name: '🔥 Classic Memes',
            value:
              'drake, distracted, twobuttons, changemymind, exitramp, expanding, pikachu, spiderman, batman, yoda',
            inline: false,
          },
          {
            name: '📈 Popular Formats',
            value:
              'stonks, doge, disaster, woman, success, rollsafe, gru, uno, brain',
            inline: false,
          },
          {
            name: '😱 Reaction Memes',
      ...
      try {
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields(
            {
              name: '⬆️ Upvotes',
              value: randomPost.ups.toLocaleString(),
              inline: true,
            },
            {
              name: '💬 Comments',
              value: randomPost.num_comments.toLocaleString(),
              inline: true,
            },
